...
class DemoDataStore {
    static let momentsData: [MomentCardData] = [
        ...
        MomentCardData(backgroundColor: .darkGray, backgroundImage: UIImage(named: "demo3")!, heading: "Bring the warmth outside", caption: "Discover", preferredCardLayout: MomentCardLayout(textAlignment: .left, headerAndCaptionVerticalCenterPercentage: 0.2)),
        ...
        MomentCardData(backgroundColor: .darkGray, backgroundImage: UIImage(named: "demo5")!, heading: "Find the perfect color", caption: "Discover", preferredCardLayout: MomentCardLayout(textAlignment: .left, headerAndCaptionVerticalCenterPercentage: 0.8)),
        ...
        MomentCardData(backgroundColor: .darkGray, backgroundImage: UIImage(named: "demo7")!, heading: "Daylight Bright", caption: "Discover", preferredCardLayout: MomentCardLayout(textAlignment: .left, headerAndCaptionVerticalCenterPercentage: 0.22)),
        MomentCardData(backgroundColor: .darkGray, backgroundImage: UIImage(named: "demo8")!, heading: "Create warmth", caption: "Discover", preferredCardLayout: MomentCardLayout(textAlignment: .left, headerAndCaptionVerticalCenterPercentage: 0.75))
    ]
}
